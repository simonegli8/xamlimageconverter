...
namespace SharpVectors.Dom.Css
{
	...
	public class CssPageRule : CssRule, ICssPageRule
	{
		...
		internal CssPageRule(Match match, object parent, bool readOnly, string[] replacedStrings, CssStyleSheetType origin) : base(parent, readOnly, replacedStrings, origin)
		{
