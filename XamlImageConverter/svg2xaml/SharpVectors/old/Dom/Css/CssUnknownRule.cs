...
namespace SharpVectors.Dom.Css
{
	...
	public class CssUnknownRule : CssRule, ICssUnknownRule
	{	
		...
		/// </summary>
		internal CssUnknownRule(object parent, bool readOnly, string[] replacedStrings, CssStyleSheetType origin) : base(parent, readOnly, replacedStrings, origin)
		{
		}
		#endregion
