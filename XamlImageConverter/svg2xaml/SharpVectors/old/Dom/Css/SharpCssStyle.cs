...
namespace SharpVectors.Dom.Css
{
	...
	internal class SharpCssStyle
	{
		...
		internal SharpCssStyle(string name, string val, string priority, int specificity, CssStyleSheetType origin) : this(name, val, priority, origin)
		{
