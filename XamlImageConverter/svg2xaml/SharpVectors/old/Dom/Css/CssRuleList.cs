...
namespace SharpVectors.Dom.Css
{
	...
	public class CssRuleList : ICssRuleList
	{
		...
		internal double InsertRule(CssRule rule, double index)
		{
			/* TODO:
		...
		internal double InsertRule(CssRule rule)
		{
		...
		internal void DeleteRule(double index)
		{
		...
		/// </summary>
		public SharpVectors.Dom.Css.ICssRule this[double index]
		{
			get
			{
