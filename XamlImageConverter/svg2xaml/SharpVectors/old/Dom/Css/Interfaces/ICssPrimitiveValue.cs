...
namespace SharpVectors.Dom.Css
{
	...
	public interface ICssPrimitiveValue
	{
		...
		/// <exception cref="DomException">INVALID_ACCESS_ERR: Raised if the attached property doesn't support the double value or the unit type.</exception>
		...
		/// <exception cref="DomException">INVALID_ACCESS_ERR: Raised if the CSS value doesn't contain a double value or if the double value can't be converted into the specified unit.</exception>
