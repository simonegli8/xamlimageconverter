...
namespace SharpVectors.Dom.Css
{
	...
	public class CssValue : ICssValue
	{
        ...
        private static Regex reCssPrimitiveValue = new Regex(cssPrimValuePattern + "$", RegexOptions.Compiled);
        private static Regex reCssValueList = new Regex(cssPrimValuePattern + @"(\s*,\s*)+$", RegexOptions.Compiled);
